#!/usr/bin/env python3
"""
AURA Task Setup with Admin - Configuración de tareas programadas en Windows con permisos de administrador
Usa pythoncom para interactuar con el Programador de Tareas de Windows
"""
...
class WindowsTaskScheduler:
    ...
    def create_task(self):
        ...
        try:
            ...
            # Configurar el trigger (programación semanal)
            trigger = task.Triggers.Create(1)  # 1 = Weekly trigger
            trigger.StartBoundary = f"2026-01-01T{TASK_TIME}:00"
            trigger.Repetition.Interval = "Weekly"
            trigger.Repetition.DaysOfWeek = [TASK_DAY]  # Domingo
            ...
            logging.info(f"Programación: Cada domingo a las {TASK_TIME}")
            logging.info(
    ...
    def get_task_status(self):
        ...
        status = {
            ...
            "schedule": f"Cada domingo a las {TASK_TIME}",
