# Compilación final corregida del APK de AME
Write-Host "============================================="
Write-Host "COMPILACION FINAL CORREGIDA DEL APK DE AME"
Write-Host "============================================="
...
$androidDir = Join-Path -Path $PSScriptRoot -ChildPath "dist\android"
Set-Location $androidDir

# Verificar si gradlew.bat existe en el directorio actual
$gradlewPath = Join-Path -Path $PSScriptRoot -ChildPath "dist\android\gradlew.bat"
...
$apkSource = Join-Path -Path $PSScriptRoot -ChildPath "dist\android\app\build\outputs\apk\debug\app-debug.apk"
