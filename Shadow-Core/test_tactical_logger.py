 agente de ia codigop"""
Script de prueba para validar el módulo TacticalEventLogger.
Simula eventos del sistema y verifica el registro de eventos.
"""
...
def test_logger():
    ...
    print(f"   Eventos habilitados: {tactical_event_logger.config['enabled_events']}")
    print(f"   Intervalo de eventos: {tactical_event_logger.config['event_interval']} segundos")
    print(f"   Tamaño máximo de cola: {tactical_event_logger.config['max_queue_size']} eventos")

    return True

def test_integration_event_bus():
    """Prueba de integración con el EventBus de AURA."""
    print("\n🔗 Probando integración con EventBus...")

    # Simular envío de evento al EventBus
    test_event = {
        "type": "test_event",
        ...
        "details": {
            ...
            "source": "test_tactical_logger"
        },
        "source": "Shadow-Core"
    }

    # Simular el método de envío al EventBus
    # En un entorno real, esto usaría websockets o HTTP
...
if __name__ == "__main__":
    ...
    try:
        # Ejecutar pruebas
        test1 = test_logger()
        test2 = test_integration_event_bus()
