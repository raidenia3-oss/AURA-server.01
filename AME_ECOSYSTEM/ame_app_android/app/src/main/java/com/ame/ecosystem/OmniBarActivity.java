...
/**
 * AURA OmniBar — Barra de comandos táctica estilo Raycast/Anzu.
 * Envía comandos a AURA PC por WebSocket/REST y muestra resultados en tiempo real.
 *
 * Comandos soportados:
 *   /bot start    → Inicia RollercoinBot
 *   /bot stop     → Detiene RollercoinBot
 *   /sys stats    → Estadísticas del sistema
 *   /web build:X  → Genera página web sobre topic X
 *   /daemon status → Telemetría del daemon
 */
